...
namespace CoreCRUDwithORACLE.Comunes
{
    ...
    {
        public string clave1 = "cadenadecifrado";
        public string DesencriptarClave(string clave)
        {
            ...
            llave = md5.ComputeHash(UTF8Encoding.UTF8.GetBytes(clave1));
            md5.Clear();
        ...
        public string Encriptar(string texto)
        {
            using (Rijndael myRijndael = Rijndael.Create())
            {
                ...
                byte[] encrypted = EncryptStringToBytes(texto, myRijndael.Key, myRijndael.IV);
        ...
        public string Desencriptar(string texto)
        {
            using (Rijndael myRijndael = Rijndael.Create())
            {
                byte[] encrypted = Encoding.ASCII.GetBytes(texto);
